    ...
    return (
      <div className="max-w-xl mx-4 sm:mx-6 md:mx-auto mt-7 md:mt-5 p-6 rounded-2xl text-center">  
        <p className="text-gray-700 mb-6 text-xl">
          You drink water. You use Google Calendar. You’ve been called “so put-together.” But are you emotionally regulated,
          or just really good at pretending everything’s fine with good lighting and a cute to-do list? Let’s find out!
        </p>
        <button
